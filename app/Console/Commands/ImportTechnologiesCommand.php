 ...
 * repeatedly is safe.
 */
class ImportTechnologiesCommand extends Command
{
    ...
    private function basePath(): string
    {
        ...
        return is_string($override) && $override !== '' ? rtrim($override, '/') : database_path('files/technologies');
    }
    ...
    /**
     * A technology removed from the repository must disappear from the site too,
    ...
    {
        $orphans = Technology::whereNotIn('slug', $keys)->get();
